...
: ${AMENT_CURRENT_PREFIX:="/home/azidozide/px4_sitl_ws/src/install/integrated_drone_mapping"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/integrated_drone_mapping/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/integrated_drone_mapping/environment/path.sh"
